...
public class ViewLowRisk extends JFrame {
	...
	ViewLowRisk() {
		...
		setTitle("Moderately Risk Pateint Details");

		headlbl = new JLabel("Moderately Risk Pateint Details");
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(add_c.lowRiskID()));
	}
